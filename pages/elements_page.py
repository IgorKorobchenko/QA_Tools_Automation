...
class TextBoxPage(BasePage):
    ...
    def fill_all_fields(self):
        person_info = next(generated_person())  #allows to generate a test person once
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = f'/Users/igorkorobchenko/Documents/Automation projects/{random.randint(0, 999)}.jpg'
